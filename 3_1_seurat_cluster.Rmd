...
pbmc.markers_3_1 <- FindAllMarkers(scRNA_3_1_cluster, only.pos = TRUE, min.pct = 0.25, logfc.threshold = 0.25)
pbmc.markers_3_1 %>% group_by(cluster) %>% top_n(n = 2, wt = avg_logFC)
